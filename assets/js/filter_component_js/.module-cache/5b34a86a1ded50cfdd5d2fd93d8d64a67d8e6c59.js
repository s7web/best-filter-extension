        ...
        React.createElement("div", {style: style}, 
          ...
          React.createElement("div", {className: "row"}, 
            selected.map(function (item) {
              return React.createElement("div", {className: "col-md-3", dangerouslySetInnerHTML: {__html: '<div class="row">' + item.thumbnail + '</div><a href="'+ item.link +'">' + headTag + item.post_name + headCloseTag + '</a>'}})
            })
          ), 
          React.createElement("div", {className: "row"}, 
            nextPrevious
