      ...
      return (
        <div style={style}>
          <div className="ot_categories">
            <h3 className="ot_trigger_cat">{filter_objects.title_cat} <i className="fa fa-plus-square"></i></h3>
            <div className="ot_filter_cat_container">
          ...
          <div className="ot_tags">
            <h3 className="ot_trigger_tag">{filter_objects.title_tag} <i className="fa fa-plus-square"></i></h3>
            <div className="ot_filter_tag_container">
          ...
          <div className="ot_used_filters_cats">
            <h3><span>{filter_objects.used_filters}</span></h3>
          ...
          <div className="row otrs_master_container">
            {selected.map(function (item) {
              return <div className="col-md-3 otrs_filter_container" dangerouslySetInnerHTML={{__html: '<div class="row otrs_filter_img_container">' + item.thumbnail + '</div><a href="'+ item.link +'">' + headTag + item.post_name + headCloseTag + '</a>'}} ></div>
            })}
          </div>
          <div className="row">
            {nextPrevious}
